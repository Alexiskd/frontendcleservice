...
const MarqueAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setError(null);
    // Pour la création, le logo est requis ; en édition, il est optionnel
    if (!form.nom || (!form.logoFile && !editMode)) {
      setError('Veuillez renseigner le nom et sélectionner un logo.');
      return;
    }

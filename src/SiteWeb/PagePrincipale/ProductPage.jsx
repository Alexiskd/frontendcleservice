...
// Le chemin relatif remonte de trois niveaux vers le dossier utils
...
const ProductPage = () => {
  ...
  // Traitement particulier pour d'anciens formats d'URL (ex : .php)
  ...
  // Redirige vers la page de commande selon le mode sélectionné ('numero' ou 'postal')

...
const CommandePage = () => {
  ...
  // État pour le produit récupéré
  const [article, setArticle] = useState(null);
  const [loadingArticle, setLoadingArticle] = useState(true);
  const [errorArticle, setErrorArticle] = useState(null);

  // Utilisation de la méthode best-by-name pour récupérer le produit
  useEffect(() => {
  ...
  const handleOrder = async () => {
    ...
    // On peut ajouter ici des validations de formulaire supplémentaires
    setOrdering(true);
    try {

...
const CleDynamicPage = () => {
  ...
  // Pour une URL du type "cle-coffre-fort-corbin.php", on retire le préfixe et l'extension
  ...
  // Chargement du logo pour la marque (uniquement si le paramètre n'est pas un slug produit)
  useEffect(() => {
    const param = brandFull || brandName;
